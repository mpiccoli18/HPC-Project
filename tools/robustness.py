...
for n in numbers:
    pred_data = pd.read_csv(f'test_1000_{n}_clustered.csv')
    y_pred = pred_data['cluster_id'].values
    ...
    print(f"Sigma: {s} | NMI: {nmi:.4f} | ARI: {ari:.4f}")

# 4. Plotting the Robustness Curve
