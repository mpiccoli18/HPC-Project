#!/bin/bash
#PBS -l select=32:ncpus=2:mpiprocs=1:mem=32gb -l place=pack:excl
...
sigmas=("1.0" "0.6" "0.45" "0.35" "0.25" "0.2" "0.15" "0.1" "0.1")
...
for i in "${!datasets[@]}"; do
    ...
    mpiexec --mca mpi_cuda_support 0 \
        ...
        -n 32 ./bin/spectral_clustering "$INPUT_PATH" "$OUTPUT_PATH" "$sigma"
done
